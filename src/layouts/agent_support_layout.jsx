    ...
    >
      ...
      >
        <div className="flex flex-col h-full">
              ...
              <button
                ...
                className={`nav-item flex items-center w-full px-4 py-3 rounded-xl transition-all duration-300 text-left transform hover:scale-105 hover:shadow-lg ${
                  activeItem === item.path
                    ? `${
                        darkMode
                          ? "bg-gradient-to-r from-green-800/80 to-green-700/80 text-white shadow-lg"
                          : "bg-gradient-to-r from-green-100/80 to-green-50/80 text-green-800 shadow-lg"
                      } active-nav-item`
              ...
              >
                ...
                <span
                  className={`transition-all duration-300 ${
                    activeItem === item.path ? "font-medium" : ""
                  }`}
                >
                  {item.name}
                </span>
          ...
          <div
            className={`p-4 border-t border-gray-200/30 dark:border-gray-700/30 backdrop-blur-sm ${
          ...
          >
            ...
            >
              <FiLogOut
                className="mr-3 text-red-600 transition-transform duration-300"
                size={20}
              />
              <span>{t("logout")}</span>
            </button>
      ...
      <div className="flex flex-col flex-1 w-0 overflow-hidden">
        ...
        <div
          className={`relative z-10 flex-shrink-0 flex h-16 backdrop-blur-xl bg-opacity-90 ${
            ...
            {children || (
              <div className="dashboard-card rounded-2xl backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 shadow-2xl p-8 transition-all duration-500 transform hover:scale-[1.02] border border-gray-200/30 dark:border-gray-700/30">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-8 text-lg">
                  Gérez les tickets de support, résolvez les litiges et
                  contactez les utilisateurs depuis cette interface.
                </p>
                ...
                <div className="text-center">
                  <p className="text-gray-500 dark:text-gray-400 text-lg">
                    Sélectionnez une option dans la barre latérale pour
                    commencer.
                  </p>
                </div>
              </div>
