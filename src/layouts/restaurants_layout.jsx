...
const translations = {
  ...
  "dashboard.welcome_popup_message":
    "Gérez votre restaurant avec facilité et suivez vos performances en temps réel.",
...
const RestaurantLayout = ({ children }) => {
  ...
  const navigationItems = [
    ...
    {
      name: translations["dashboard.orders"],
      icon: <FiShoppingBag size={20} />,
      path: "/restaurant/orders",
      badge: notifications,
    },
    {
      name: translations["dashboard.menu"],
      icon: <FiBarChart2 size={20} />,
      path: "/restaurant/menu",
    },
    {
      name: translations["dashboard.stats"],
      icon: <FiDollarSign size={20} />,
      path: "/restaurant/stats",
    },
    {
      name: translations["dashboard.reviews"],
      icon: <FiStar size={20} />,
  ...
  return (
    ...
    >
      ...
      <aside
        ...
        } shadow-2xl transition-all duration-300 ease-in-out border-r backdrop-blur-xl`}
        style={{
          width: "280px",
          transform:
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex flex-col p-6 border-b border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-green-50 to-yellow-50 dark:from-gray-800 dark:to-gray-700">
            ...
            >
              <h3 className="font-semibold text-base truncate text-gray-800 dark:text-white">
                {restaurantData.name}
              </h3>
              ...
              <button
                ...
                className={`relative flex items-center w-full px-4 py-4 rounded-xl transition-all duration-200 text-left group border ${
                  activeItem === item.path
                    ? `${
                        darkMode
                          ? "bg-gradient-to-r from-green-700 to-yellow-600 text-white shadow-xl border-green-500"
                          : "bg-gradient-to-r from-green-500 to-yellow-500 text-white shadow-lg border-green-400"
                      }`
          ...
          >
            <div className="flex items-center p-3 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700/50 cursor-pointer transition-all duration-200 mb-4 border border-transparent hover:border-gray-200 dark:hover:border-gray-600">
              ...
              <div className="ml-4">
                <p className="font-semibold text-sm text-gray-800 dark:text-white">
                  {translations["dashboard.manager"]}
                </p>
            ...
            >
              <FiLogOut
                className="mr-3 text-red-600 group-hover:scale-110 transition-transform"
                size={18}
              />
      ...
      <div className="flex flex-col flex-1 w-0 overflow-hidden">
        {/* Top Navigation Bar */}
        <div
          className={`relative z-10 flex-shrink-0 flex h-18 ${
            darkMode
              ? "bg-gray-800/95 border-gray-700"
              : "bg-white/95 border-gray-200"
          } shadow-lg border-b backdrop-blur-xl`}
        >
          <button
            ...
            <div className="ml-4 flex items-center md:ml-6 space-x-4">
              ...
              >
                {darkMode ? (
                  ...
                  <HiOutlineMoon
                    className="text-gray-500 drop-shadow-lg"
                    size={26}
                  />
                )}
              </button>
