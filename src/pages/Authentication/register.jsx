...
const Register = () => {
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const newUserData = await AuthServices.createUser(userInfo);
      // }, 3000);

      const newUser = newUserData.user;
      setUserIdFor2FA(newUserData.firebase_uid);
      setContactMethod(newUserData.phone_number); // ou email
    ...
    <>
      ...
      {!verificationStep ? (
                              ...
                              >
                                {formData.delivery_documents.id_document ? (
                                  ...
                                  <div className="flex flex-col items-center space-y-2">
                                    ...
                                    >
                                      Cliquez pour ajouter votre pièce
                                      d'identité
                                    </p>
                                    <p
                                      className={`text-xs ${
                              ...
                              >
                                {formData.delivery_documents.driving_license ? (
                                  ...
                                  <div className="flex flex-col items-center space-y-2">
                                    ...
                                    >
                                      Cliquez pour ajouter votre permis de
                                      conduire
                                    </p>
                                    <p
                                      className={`text-xs ${
        ...
        <Verify2FACode
          ...
          onResendCode={() => {
            // Implémentez la fonction pour renvoyer le code
            axios.post("/resend-2fa-code", { userId: userIdFor2FA });
          }}
        />
      )}
    </>
