...
const AdminDashboard = () => {
  ...
  const statsRestaurantsCategorie = () => {
    try {
      ...
      return [
        { name: 'Africain', value: listOfAfricanRestaurant.length },
        { name: 'Fast Food', value: listOfFastFoodRestaurant.length },
        { name: 'Asiatique', value: listOfAsianRestaurant.length },
        { name: 'Européen', value: listOfEuropeanRestaurant.length },
        { name: 'Autre', value: listOfOtherRestaurant.length },
      ];
    } catch (error) {
  ...
  // Mock data for charts with French labels
  const weeklyRevenueData = [
    ...
    { day: 'Ven', revenue: 68000, orders: 35 },
    { day: 'Sam', revenue: 72000, orders: 38 },
    { day: 'Dim', revenue: 55000, orders: 29 }
  ];

  const monthlyOrdersData = [
    { month: 'Jan', orders: 120, revenue: 180000 },
    { month: 'Fév', orders: 135, revenue: 200000 },
    { month: 'Mar', orders: 150, revenue: 225000 },
    { month: 'Avr', orders: 140, revenue: 210000 },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-6 transition-colors duration-300">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        {/* Revenue Chart */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Chiffre d'affaires hebdomadaire</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 transition-colors duration-300">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Distribution des catégories</h3>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={categoryData}
        ...
        <div className="space-y-4">
          ...
          {newRestaurants().map((restaurant, index) => (
            <div key={index} className="flex items-center space-x-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg transition-colors duration-300">
              ...
              <div className="flex-1">
                <p className="font-medium text-gray-900 dark:text-white">Nouveau restaurant inscrit: {restaurant.name}</p>
