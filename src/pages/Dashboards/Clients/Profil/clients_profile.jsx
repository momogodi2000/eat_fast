        ...
        <div className="flex-1 text-center text-white">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-1 sm:gap-2 md:gap-3 lg:gap-4 mt-3 sm:mt-4 md:mt-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-1 sm:p-2 md:p-3 text-center transform transition-all duration-300 hover:bg-white/20">
              ...
              <div className="text-[10px] xs:text-xs sm:text-sm text-white/80">
                Commandes
              </div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-1 sm:p-2 md:p-3 text-center transform transition-all duration-300 hover:bg-white/20">
              <div className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold">
                {profileData.stats.favoriteRestaurants}
              </div>
              <div className="text-[10px] xs:text-xs sm:text-sm text-white/80">
                Favoris
              </div>
        ...
        <div className="flex gap-1 px-2 py-1 bg-white rounded-lg sm:rounded-xl shadow-md overflow-x-auto scrollbar-hide">
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                <Icon
                  className={`w-3 h-3 sm:w-4 h-4 transition-all duration-300 ${
      ...
      <div className="space-y-2 sm:space-y-3 md:space-y-4">
        {formData.addresses.map((address) => (
          ...
          >
            <div className="flex justify-between items-start mb-2 sm:mb-3 md:mb-4">
              <div className="flex items-center gap-2 sm:gap-3 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <h3 className="font-semibold text-xs sm:text-sm md:text-base lg:text-lg capitalize truncate">
            ...
            <p className="text-gray-600 mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base break-words">
              {address.address}
            </p>
  ...
  const PreferencesTab = () => (
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg md:shadow-xl p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="space-y-4 sm:space-y-5 md:space-y-6 lg:space-y-8">
        <div>
          <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold mb-2 sm:mb-3 md:mb-4 text-gray-800">
            Cuisines préférées
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-2 md:gap-3">
            {[
              ...
              <label
                key={cuisine}
                className="flex items-center gap-1 sm:gap-2 cursor-pointer p-1 sm:p-2 hover:bg-gray-50 rounded-md sm:rounded-lg"
              >
                <input
                  type="checkbox"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-2 md:gap-3">
            {["Halal", "Végétarien", "Végan", "Sans gluten", "Casher"].map(
              (dietary) => (
                <label
                  key={dietary}
                  className="flex items-center gap-1 sm:gap-2 cursor-pointer p-1 sm:p-2 hover:bg-gray-50 rounded-md sm:rounded-lg"
    ...
    <div className="bg-white rounded-xl sm:rounded-2xl shadow-md sm:shadow-lg md:shadow-xl p-3 sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="space-y-4 sm:space-y-5 md:space-y-6">
        <div className="border border-gray-200 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-6">
          <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold mb-2 sm:mb-3 md:mb-4">
          ...
          <div className="space-y-2 sm:space-y-3">
            <div className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 rounded-md sm:rounded-lg">
              ...
              <div className="text-right">
                ...
                <div className="text-[10px] xs:text-xs sm:text-sm text-green-600">
                  Payé
                </div>
              </div>
            </div>
